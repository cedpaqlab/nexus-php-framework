...
class UserTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'Models.Map.UserTableMap';
     ...
     */
    public const OM_CLASS = '\\App\\Models\\User';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Models.User';
     ...
     */
    public const COL_ROLE = 'users.role';
    ...
    public const COL_ROLE_SUPER_ADMIN = 'super_admin';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'Email', 'Password', 'Name', 'Role', 'CreatedAt', 'UpdatedAt', ],
        self::TYPE_CAMELNAME     => ['id', 'email', 'password', 'name', 'role', 'createdAt', 'updatedAt', ],
        self::TYPE_COLNAME       => [UserTableMap::COL_ID, UserTableMap::COL_EMAIL, UserTableMap::COL_PASSWORD, UserTableMap::COL_NAME, UserTableMap::COL_ROLE, UserTableMap::COL_CREATED_AT, UserTableMap::COL_UPDATED_AT, ],
        self::TYPE_FIELDNAME     => ['id', 'email', 'password', 'name', 'role', 'created_at', 'updated_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'Email' => 1, 'Password' => 2, 'Name' => 3, 'Role' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'email' => 1, 'password' => 2, 'name' => 3, 'role' => 4, 'createdAt' => 5, 'updatedAt' => 6, ],
        self::TYPE_COLNAME       => [UserTableMap::COL_ID => 0, UserTableMap::COL_EMAIL => 1, UserTableMap::COL_PASSWORD => 2, UserTableMap::COL_NAME => 3, UserTableMap::COL_ROLE => 4, UserTableMap::COL_CREATED_AT => 5, UserTableMap::COL_UPDATED_AT => 6, ],
        self::TYPE_FIELDNAME     => ['id' => 0, 'email' => 1, 'password' => 2, 'name' => 3, 'role' => 4, 'created_at' => 5, 'updated_at' => 6, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, 6, ]
    ];
    ...
    public function initialize(): void
    {
        ...
        $this->addColumn('role', 'Role', 'ENUM', true, null, 'user');
